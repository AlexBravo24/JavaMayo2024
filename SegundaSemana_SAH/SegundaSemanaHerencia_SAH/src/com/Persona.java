...
public abstract class Persona {
	...
	//Creación de Métodos Propios
		...
		public String comer(String comida, int horario, String compañia) {
			return null;
		}
		
		//La sobrecarga de argumentos vva de la mano con la sobrecarga de métodos
		//La sobrecarga de métodos se podría entender que es tener un método polimorfico
		//o varios métodos con el mismo nombre, pero que van a realizar diferentes acciones 
		...
		//las clases hijas se ven obligadas a definir COMO SE va a realizar esta acción
		public abstract void sumar (int a, int b);
		
		//Un método abstracto nos indica QUÉ se va a hacer pero no CÓMO
		
		//Otra forma de entender las clases abstractas es por medio de la definion
