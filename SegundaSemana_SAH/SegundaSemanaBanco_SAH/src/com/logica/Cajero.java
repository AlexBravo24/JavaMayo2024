...
public class Cajero implements IMetodos{
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		//Entonces asignamos posteriormente la cueta si existe en el HashMap
	...
	//Primero, si se encuentra o localiza la cuenta, las asignamos
	//para manipularla
	if (consultar(numeroCuenta) !=null) {
			...
			if(monto>9000) {
				...
				return ticket;
			}else if(cuenta.getSaldo()<monto) {//Si el saldo es menor a retirar
				...
				//Actualizamos el saldo de nuestra ceungta
