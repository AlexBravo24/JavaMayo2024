...
//		}
		...
		//Recuperar todos los elementos con el siclo forEach
...
//		original.forEach(a -> System.out.println(a));
		...
		//Si filtraramos a los elementos del método masculino
...
//		System.out.println(alguno);
		//(allMatch para todo los valores/anyMatch para solo un valor)
		
		//Retornar un valor a una clase Optional
		/*Optional es una clase que nos permite mejorar valores nulos,
