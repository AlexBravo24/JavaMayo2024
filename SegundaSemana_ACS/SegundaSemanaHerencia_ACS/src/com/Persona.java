...
public abstract class Persona {
	...
	//dato que el método debe resolver
	...
	//Crear otro método Polimorfico
	public String comer(String comida) {
		String comiendo = "Estoy comiendo " + comida + " a las 2pm";
		return comiendo;
	}
	
	//Creando un método comer, pero en otro argumento
	public String comer(String comida, int horario) {
		String comiendo = "Estor comiendo " + comida + " a las " + horario + "pm";
		return comiendo;
	}
	...
	//que son clases "resumen", que nos va a permitir heredarlas
