...
public class Persona {
	...
	//Son aquelos métodos que nos permiten instanciar o crear a nuestros objetos
	//con determinados atributos
	//Existen dos principales: Constructor vacio y constructor con todos los parametros
	
	//Constructor vacio - nos permite crear un objeto sin tener iniciados sus atributos
