...
//		}
		...
		//NOT - ! Niega una condición o sentencia/Cambia el valor
...
//		}
		...
		//Este operador funciona mejor al comparar valores numéricos
...
//		}
//		
		//DIFERENTE DE - != - Devuelve el valor true si la condición 
		//es diferente de lo que se está evaluando
//		if (x != 20) {
//			System.out.println("Si");
//		}else {
//			System.out.println("No");
...
//		}else if (dia == 2) { //si lo anterior no se cumple
