...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		/*
		 * Los arrays o arreglos, o también conocidos como "vectores" son una estructura
		 * de datos que nos permiten almacenar un tipo de datos en común son una especie
		 * de coleccón de datos
		 */

		// Una vez declarado su tamaño o longitud, este no puede crecer
		// en tiempo de ejecución

		// Formas de declara un array de numeros enteros con su tamaño
