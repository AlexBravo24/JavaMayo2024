...
public class Cajero implements IMetodos{
	...
	//Declarar una variable auxiliar para aumentar el folio en nuestro ticket
	private int folio=1;
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		//Vamos a buscar la cuenta y necesitamos hacer unas vcalidaciones 
		//Primero, si se encuentra o  localiza la cuenta, la signamos para manipularla
		if (consultar(numeroCuenta) != null) {
			Cuenta cuenta = consultar (numeroCuenta);
			//Una vez localizamos la cuenta para manipularla 
	...
	public Ticket depositar(int numeroCuenta, double monto) {
		...
		if(consultar(numeroCuenta) != null) {
			...
			System.out.println("No hay cuenta asociada a esa cuenta");
			return ticket;	
		}
	}
}
